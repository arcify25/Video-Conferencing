...
import { firebaseAuth, meetingRef } from "../util/FireBaseConfig";
import { signOut } from "firebase/auth";
import { generateMeetingId } from "../util/generateMeetingId";
import { EuiButton, EuiFlexGroup, EuiFlexItem, EuiButtonIcon } from "@elastic/eui";
...
export default function JoinMeeting() {
    ...
    const appId = 1682121481;
    const serverSecret = "05d3089c2028cdccb6d3603ee8a97962";
